...
public class FilmControllerTest {
    ...
    public FilmEntity createEntity() {
        ...
        filmEntity.setRentalRate(1D);
        filmEntity.setReplacementCost(1D);
    ...
    public CreateFilmInput createFilmInput() {
        ...
        filmInput.setRentalRate(5D);
        filmInput.setReplacementCost(5D);
    ...
    public FilmEntity createNewEntity() {
        ...
        film.setRentalRate(3D);
        film.setReplacementCost(3D);
        film.setTitle("3");
    ...
    public FilmEntity createUpdateEntity() {
        ...
        film.setRentalRate(4D);
        film.setReplacementCost(4D);
        film.setTitle("4");
    ...
    public void UpdateFilm_FilmDoesNotExist_ReturnStatusNotFound() throws Exception {
        ...
        film.setRentalRate(999D);
        film.setReplacementCost(999D);
        film.setTitle("999");
