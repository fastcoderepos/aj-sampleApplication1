  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [FilmActorListComponent, ListComponent],
        imports: [TestingModule],
        providers: [FilmActorService, ChangeDetectorRef],
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/filmactor/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
