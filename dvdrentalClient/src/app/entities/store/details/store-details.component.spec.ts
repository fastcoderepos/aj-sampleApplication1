...
import { IStore, StoreService, StoreDetailsComponent, StoreListComponent } from '../';
...
describe('StoreDetailsComponent', () => {
  ...
  describe('Unit Tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [StoreDetailsComponent, DetailsComponent],
  ...
  describe('Integration Tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [StoreDetailsComponent, StoreListComponent, DetailsComponent, ListComponent, FieldsComp].concat(
          EntryComponents
        ),
        imports: [
          TestingModule,
          RouterTestingModule.withRoutes([
            ...
            { path: 'store/:id', component: StoreListComponent },
          ]),
        ],
        providers: [StoreService],
      }).compileComponents();
