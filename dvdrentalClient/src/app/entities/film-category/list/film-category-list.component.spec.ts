  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [FilmCategoryListComponent, ListComponent],
        imports: [TestingModule],
        providers: [FilmCategoryService, ChangeDetectorRef],
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/filmcategory/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
