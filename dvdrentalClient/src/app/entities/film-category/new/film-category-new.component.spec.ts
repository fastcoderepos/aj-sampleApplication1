  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [FilmCategoryNewComponent, NewComponent, FieldsComp],
        imports: [TestingModule],
        providers: [FilmCategoryService, { provide: MAT_DIALOG_DATA, useValue: {} }],
  ...
  describe('Integration tests', () => {
    ...
    describe('', () => {
      it('should set the passed data to form', async () => {
        TestBed.configureTestingModule({
          declarations: [FilmCategoryNewComponent, NewComponent, FieldsComp].concat(EntryComponents),
          imports: [TestingModule],
          providers: [FilmCategoryService, { provide: MAT_DIALOG_DATA, useValue: relationData }],
        });
