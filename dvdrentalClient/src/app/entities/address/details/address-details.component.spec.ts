...
import { IAddress, AddressService, AddressDetailsComponent, AddressListComponent } from '../';
  ...
  describe('Unit Tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [AddressDetailsComponent, DetailsComponent],
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            ...
            { path: 'address/:id', component: AddressListComponent },
          ]),
        ],
        providers: [AddressService],
      }).compileComponents();
