...
import { ICity, CityService, CityDetailsComponent, CityListComponent } from '../';
...
describe('CityDetailsComponent', () => {
  ...
  describe('Unit Tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [CityDetailsComponent, DetailsComponent],
  ...
  describe('Integration Tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [CityDetailsComponent, CityListComponent, DetailsComponent, ListComponent, FieldsComp].concat(
          EntryComponents
        ),
        imports: [
          TestingModule,
          RouterTestingModule.withRoutes([
            ...
            { path: 'city/:id', component: CityListComponent },
          ]),
        ],
        providers: [CityService],
      }).compileComponents();
    ...
    it('should go back to list component when back button is clicked', async () => {
      ...
      expect(location.path()).toBe('/city');
    });
  });
});
