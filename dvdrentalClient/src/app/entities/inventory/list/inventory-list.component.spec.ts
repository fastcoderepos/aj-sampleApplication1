  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [InventoryListComponent, ListComponent],
        imports: [TestingModule],
        providers: [InventoryService, ChangeDetectorRef],
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/inventory/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
